                ...
                <ul className="mt-4">
                  ...
                  <li className="">
                    ...
                    <article>
                      ...
                      <p className="mt-2 mb-6">
                        In 2D DASH JAVASCRIPT GAME, you control a small iconic character
                        that automatically moves forward through a
                        two-dimensional level. The gameplay is straightforward:
                        tap to jump and avoid obstacles. The challenge comes
                        from the timing of your taps
                      </p>
                      <h5 className="mt-2 mb-2">Technologies used:</h5>
                      <h6 className="mt-2 mb-2">
                        The project is built using a combination of technologies
                  ...
                  <li className="">
                    ...
                    <article>
                      ...
                      <p className="mt-2 mb-6">
                        ...
                        projects in the Libraries-Projects repository on GitHub.
                      </p>
                  ...
                  <li className="">
                    <article>
                      ...
                      <p className="mt-2 mb-4">
                        ...
                        triggered by clicking a corresponding button or pressing
                        a specific key on the keyboard. The drum sounds include
                        a variety of drum beats and cymbals, allowing users to
                        create their own percussion music. But in this case, I
                        added sounds from the Zelda video game, to make it a bit
                        more different and fun.
                      </p>
                      <h5 className="mt-2 mb-2">Technologies used:</h5>
                      <h6 className="mt-2 mb-2">
                        The project is built using a combination of technologies
